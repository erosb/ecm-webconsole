...
@Component(name = "org.everit.osgi.webconsole.tests", metatype = true, policy = ConfigurationPolicy.OPTIONAL,
immediate = true)
@Properties({
        ...
        @Property(name = "dummyService.target", description = "this is a dummy service")
})
...
public class TestComponent {
    ...
    public void bindDummyService(final DummyService dummyService) {
